...
function Sidebar({children}: SidebarProps) {
  ...
  return (
    <aside className={`${isProductDetailOpen || isCheckoutOpen ? 'flex' : 'hidden'} sidebar scrollable-cards flex-col fixed right-0 border border-black rounded-lg bg-white`}>
